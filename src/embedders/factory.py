...
__all__ = ["create_embedder", "create_embedder_by_name", "get_available_embedders", "EXPERIMENT_CONFIGS", "benchmark_embedder"]
...
async def benchmark_embedder(
    ...
    return {
        ...
        "throughput_texts_per_sec": len(test_texts) / (sum(latencies) / len(latencies) / 1000)
    }
