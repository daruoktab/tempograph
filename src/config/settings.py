...
GEMINI_RATE_LIMITS: Dict[str, ModelRateLimit] = {
    ...
    "gemini-embedding-001": ModelRateLimit(
        rpm=1500,
        tpm=10_000_000,
        rpd=None
    ),
...
class EmbedderExperimentConfig:
    ...
    embedders_to_test: list = field(default_factory=lambda: [
...
class LLMExperimentConfig:
    ...
    llm_providers_to_test: list = field(default_factory=lambda: [
...
class Config:
    ...
    embedder_experiment: EmbedderExperimentConfig = field(default_factory=EmbedderExperimentConfig)
